...
- Name: workflows/core-workflows.e2e.spec.ts >> profile lifecycle: create + unlock + session persisted
- Location: e2e_tests/workflows/core-workflows.e2e.spec.ts:35:1
